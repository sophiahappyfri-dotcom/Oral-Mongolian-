...
For example
"Altangerel_080201A"
0. preperation: First, visit the main browse page [https://www.amantuuh.socanth.cam.ac.uk/pages/browse.php]. Identify all rows in the "Main project interviews" table. For each unique Interview ID found in the table, repeat the following steps:
